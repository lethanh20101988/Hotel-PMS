...
export type WarehouseVoucherTT58ImportPrintProps = {
...
/**
 * Phiếu nhập kho (01-VT) theo Thông tư 58/2026/TT-BTC — bản in.
 */
export const WarehouseVoucherTT58ImportPrint: React.FC<WarehouseVoucherTT58ImportPrintProps> = ({
  transaction,
  itemSku,
  itemUnit,
  printUnit,
  ...
  const header = getWarehouseVoucherPrintHeader('TT58_2026', true);
  ...
  const SignatureColumn: React.FC<{
    ...
    <div className="voucher-sign-col flex flex-col items-center text-center">
      ...
      <div
        className="mt-1.5 h-14 w-full print:mt-1 print:h-12"
        aria-hidden
      />
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative mb-3">
        ...
        <h1 className="text-center text-[17px] font-bold tracking-tight uppercase">Phiếu nhập kho</h1>
      ...
      <div className="mb-3 space-y-1.5 text-[11px]">
        ...
        <p>
          <span className="font-bold">- Theo số</span>{' '}
          <span className="border-b border-dotted border-black px-1">
        ...
        <p>
          <span className="font-bold">Nhập tại kho:</span>{' '}
      ...
      <table className="w-full border-collapse border border-black text-[10px] print:table-fixed">
        <thead className="print:table-header-group">
          ...
          <tr>
            ...
            <th className="border border-black px-0.5 py-0.5 font-normal">Thực nhập</th>
          </tr>
          <tr>
      ...
      <div className="inventory-voucher-tt58-signatures mt-8 text-[10px] print:mt-6">
        ...
        <div className="grid grid-cols-3 gap-3 text-center print:gap-2">
          <SignatureColumn title="Người giao hàng" />
